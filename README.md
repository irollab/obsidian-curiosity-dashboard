...
![发现 tab](docs/screenshots/discover.png)

![工作流 tab](docs/screenshots/workflow.png)

![数据 tab](docs/screenshots/data.png)

> 截图待补充——详见 [docs/screenshots-checklist.md](docs/screenshots-checklist.md)。截图应在独立测试 Vault 使用虚构示例数据，并先移除账号、文件路径、私密评论和其他个人信息。
